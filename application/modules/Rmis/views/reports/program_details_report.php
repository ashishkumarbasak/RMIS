...
<div id="page-content" class="clearfix">
  <div class="page-header position-relative">
    <h1>Program Details Information</h1>
  </div>
  <form action="<?php echo site_url('/Rmis/Reports/ProgramDetailsReport/getReportExport'); ?>" method="post" id="reportForm">
    <div class="row-fluid">
      <div class="span12">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                     <label for="asdf">Title of the Program</label>
						<textarea name="research_program_title" id="research_program_title" class="textarea_small" style="width:94.5%;"></textarea>
                    </div>                                                            
                  <div class="span3">
...
$(function() {
	...
	var options = {
		type: 'POST',
		url:  "<?php echo site_url('/Rmis/Reports/ProgramDetailsReport/getReport'); ?>", 
		async: false,			
