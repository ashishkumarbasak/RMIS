...
<div id="page-content" class="clearfix">
  <div class="page-header position-relative">
    <h1>Division Wise Projects and Experiments List</h1>
  </div>
  <form action="<?php echo site_url('/Rmis/Reports/DivisionWiseReport/getReportExport'); ?>" method="post" id="reportForm">
    <div class="row-fluid">
      <div class="span12">
...
$(function() {
	...
	var options = {
		type: 'POST',
		url:  "<?php echo site_url('/Rmis/Reports/DivisionWiseReport/getReport'); ?>", 
		async: false,			
