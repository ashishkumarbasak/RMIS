...
<div id="page-content" class="clearfix">
  <div class="page-header position-relative">
    <h1>Logical Framework</h1>
  </div>
  <form action="<?php echo site_url('/Rmis/Reports/LogicalFramework/getReportExport'); ?>" method="post" id="reportForm">
    <div class="row-fluid">
      <div class="span12">
          ...
          <div class="widget-body">
            <div class="widget-body-inner " style="display: block;">
              <div class="widget-main">
                ...
                <div class="row-fluid">
                 <label for="asdf">Title of Research Project</label>
                    <textarea name="research_project_title" id="research_project_title" class="textarea width_68_percent"></textarea>
                </div> 
                <div class="row-fluid">
                 <label for="asdf">Title of the Program</label>
                    <textarea name="research_program_title" id="research_program_title" class="textarea width_68_percent"></textarea>
                </div>                                                           
                  <div class="span3">
...
$(function() {
	...
	jQuery("#reportForm").validate({
			rules: {
				...
				messages: {
					...
					research_project_title: {
						required: "Please enter Title of Research Project"
					}				
				}
		});
	...
	var options = {
		type: 'POST',
		url:  "<?php echo site_url('/Rmis/Reports/LogicalFramework/getReport'); ?>", 
		async: false,			
