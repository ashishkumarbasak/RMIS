...
<div id="page-content" class="clearfix">
  <div class="page-header position-relative">
    <h1>Program Area Wise Projects and Experiments Details</h1>
  </div>
  <form action="<?php echo site_url('/Rmis/Reports/ProgramAreaWiseReport/getReportExport'); ?>" method="post" id="reportForm">
    <div class="row-fluid">
      <div class="span12">
              ...
              <div class="widget-main">
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                     ...
                     <div class="span3">
                        <div class="row-fluid">
                            <label for="sub_group_ifsdfd">Department Name</label>
...
$(function() {
	...
	var options = {
		type: 'POST',
		url:  "<?php echo site_url('/Rmis/Reports/ProgramAreaWiseReport/getReport'); ?>", 
		async: false,			
