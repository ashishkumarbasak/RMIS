	...
	<div class="form_element">
    	<div class="button_panel" style="margin-right: 15px;">
        		<?php if(isset($program_detail) && ($researchTeam!=NULL || $teamMembers!=NULL)) { ?>
		    		...
		    		<input type="submit" name="delete_program_implcommittee" id="delete_program_implcommittee" value="Delete" onclick="javascript:return confirm('Do you want to delete this program implementation committee?');" class="k-button button">
		    	<?php } else { ?>
	                <input type="hidden" name="program_id" id="program_id" value="<?php if($program_id!=NULL) echo $program_id; ?>">
