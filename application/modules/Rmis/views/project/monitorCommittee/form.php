...
<?php 
	...
	if(isset($monitoringCommittee)){
		$monitoringCommittee = unserialize($monitoringCommittee);
	}
	...
	<div class="main_form">
		<div class="left_form">
        	<div class="form_element">
                ...
                <div class="field">
               		<input type="text" name="committee_formation_date" id="committee_formation_date" value="<?php if($monitoringCommittee) { if($monitoringCommittee->committee_formation_date=='0000-00-00'){echo '';} else {echo $monitoringCommittee->committee_formation_date;}}?>" data-date-format="yyyy-mm-dd" class="textbox disabled" readonly="readonly">
		...
		<div class="form">
	    	...
	    	?>
				    ...
				    <div class="row add-more"><a href="javascript:void(0);" onclick="delete_monitorCommittee_team_member(<?php echo $member->id;?> , <?php echo $member->project_id; ?>, <?php echo $key; ?> );">[-]</a></div>
				    </div>
	    	<?php	
					$g++;			
	    			}
	...
	<div class="form_element">
    	<div class="button_panel" style="margin-right: 15px;">
	        	<?php if(isset($project_detail) && ($researchTeam!=NULL || $teamMembers!=NULL)) { ?>
                    ...
                    <input type="submit" name="update_monitoring_committee" id="update_monitoring_committee" value="Update" class="k-button button">
		    		<input type="button" name="delete_monitoring_committee" id="delete_monitoring_committee" value="Delete" class="k-button button">		            
		    	<?php } else { ?>
	                <input type="hidden" name="project_id" id="project_id" value="<?php if($project_id!=NULL) echo $project_id; ?>">
	            	<input type="submit" name="save_monitoring_committee" id="save_monitoring_committee" value="Save" class="k-button button">
                <?php } ?>
        </div>
        <div class="clear"></div>
    </div>
