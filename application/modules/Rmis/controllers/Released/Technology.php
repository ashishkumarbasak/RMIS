...
class Technology extends MX_Controller{
    ...
    public function index($Type=NULL, $ID=NULL, $tech_release_id=NULL){
		...
		$result_program = $this->employee->read_technology_release_programs();
		$result_project = $this->employee->read_technology_release_projects();
		$result_experiment = $this->employee->read_technology_release_experiments();     
