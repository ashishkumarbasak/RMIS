<?php
class SearchExperiment extends MX_Controller{
    private $_data;
    ...
    public function index($division_id=NULL){
        ...
        $this->template->set_partial('divInfoForm','framework/experiment_search/form');
        $this->template->build('framework/experiment_search/index');
    }           
} 
?>