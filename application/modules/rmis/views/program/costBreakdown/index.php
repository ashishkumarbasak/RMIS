                ...
                <div class="main_form">
                    ...
                    <div class="left_form">
                        ...
                        <div class="form_element">
                            ...
                            <div class="field">
                            <input type="text" name="fund_budget" id="fund_budget" value="" class="textbox" disabled="disabled">
                            </div>
                            <div class="clear"></div>
                        </div> 
                    ...
                    <div class="right_form">    
                      <div class="form_element">
                        ...
                        <div class="form_element">
                            <div class="label">Principal Investigator <br />(or PM/Coordinator)</div>
                            <div class="field">
                            	<input type="text" name="fund_investigator" id="fund_investigator" value="" class="textbox" disabled="disabled">
                            </div>
                            <div class="clear"></div>
                        </div>
                    </div>
