<script type="text/javascript">
	jQuery(function($) {
		...
		$( "#comittee_formation_date" ).datepicker({
                ...
                <div class="main_form">
                    ...
                    <div class="left_form">
                        <div class="form_element">
                            ...
                            <div class="field">
                            <input type="text" name="fund_area" id="fund_area" value="" class="textbox">
                            </div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="form_element">
                            ...
                            <div class="field">
                            <input type="text" name="team_info_startdate" id="team_info_startdate" value="" class="textbox" disabled="disabled">
                            </div>
                            <div class="clear"></div>
                        </div>  
                        ...
                        <div class="form_element">
                            ...
                            <div class="field">
                            <input type="text" name="team_info_enddate" id="team_info_enddate" value="" class="textbox" disabled="disabled">
                            </div>
                            <div class="clear"></div>
                        </div>
                    ...
                    <div class="right_form">    
                      <div class="form_element">
                        ...
                        <div class="form_element">
                            ...
                            <div class="field">
                            <input type="text" name="team_info_initiationdate" id="team_info_initiationdate" value="" class="textbox" disabled="disabled">
                            </div>
                            <div class="clear"></div>
                        </div>
                         ...
                         <div class="form_element">
                            ...
                            <div class="field">
                            <input type="text" name="team_info_completiondate" id="team_info_completiondate" value="" class="textbox" disabled="disabled">
                            </div>
                            <div class="clear"></div>
                        </div>
                    </div>                                                 
                  ...
                  <fieldset>
    				<legend>Steering Comittee Information</legend>
                    <div class="main_form">
                        <div class="form_element">
                            <div class="label">Comittee Formation Date:</div>
                            <div class="field">
                                <input type="text" class="form-control hasDatepicker" name="comittee_formation_date" id="comittee_formation_date">
