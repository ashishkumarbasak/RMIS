        ...
        <div class="eight columns" style="margin:0 auto; padding-left:5px; width:99%;">
          ...
          <div class="tabs-container">
            ...
            <fieldset>
                ...
                <fieldset>
    				<legend>Program Related Document</legend>
                    <div class="main_form">
                        	<div class="left_form"> 
                                ...
                                <div class="form_element">
                                    ...
                                    <div class="field">
                                        <input type="text" name="team_info_completiondate" id="team_info_completiondate" value="" class="textbox">
                                    </div>
                                    <div class="clear"></div>
                                </div>
                                
                                <div class="form_element">
                                    <div class="label">File/Document Type *</div>
                                    <div class="field">
                                        <select name="commodity" id="commodity" class="selectionbox">
                                            <option>Select (Derive Commodity)</option>
                                            <option>Select (Derive Commodity)</option>                            
                                        </select>
                                    </div>
                                    <div class="clear"></div>
                                ...
                                <div class="form_element">
                                    <div class="label">File/Document *</div>
                                    <div class="field">
                                ...
                                <div class="form_element">
                                    <div class="label">Sorting Order *</div>
                                    <div class="field">
                                        <input type="text" name="team_info_completiondate" id="team_info_completiondate" value="" class="textbox">
                                    </div>
                                    <div class="clear"></div>
                                ...
                                <div class="form_element">
                                    <div class="label">&nbsp;</div>
                                    <div class="field">
                                        <input type="submit" name="team_info_completiondate" id="team_info_completiondate" value="Upload">
                                    </div>
                                    <div class="clear"></div>
                                </div>
