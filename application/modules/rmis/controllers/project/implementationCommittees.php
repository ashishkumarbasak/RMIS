...
class ImplementationCommittees extends MX_Controller{
    ...
    public function index($project_id=NULL){
        $this->template->title('Research Management(RM)', ' Project', ' Project Implementation Committee Information');
	...
	public function deleteTeamMember(){
		...
		$this->project->deleteImplementationCommitteeMemberFromProject($team_member_id,$project_id);
	}            
} 
?>