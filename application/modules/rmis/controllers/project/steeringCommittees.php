...
class SteeringCommittees extends MX_Controller{
    ...
    public function index($project_id=NULL){
        $this->template->title('Research Management(RM)', ' Project', ' Project Steering Committee Information');
	...
	public function deleteTeamMember(){
		...
		$this->project->deleteSteeringCommitteeTeamMemberFromProject($team_member_id,$project_id);
	}
