...
class ActivityLists extends MX_Controller{
    ...
    public function index(){
        $this->template->title('Research Management(RM)', ' Programs', ' Activity Lists');
