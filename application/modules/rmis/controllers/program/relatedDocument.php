...
class RelatedDocument extends MX_Controller{
    private $_data;
    ...
    public function index(){
        $this->template->title('Research Management(RM)', ' Programs', ' Program Related Document');
        ...
        $create->url(site_url('rmis/program/relatedDocument/dataCreate'))
             ->contentType('application/json')
             ->type('POST');

        $read = new \Kendo\Data\DataSourceTransportRead();

        $read->url(site_url('rmis/program/relatedDocument/dataRead'))
             ->contentType('application/json')
             ->type('POST');

        $update = new \Kendo\Data\DataSourceTransportUpdate();

        $update->url(site_url('rmis/program/relatedDocument/dataUpdate'))
             ->contentType('application/json')
             ->type('POST');

        $destroy = new \Kendo\Data\DataSourceTransportDestroy();

        $destroy->url(site_url('rmis/program/relatedDocument/dataDestroy'))
             ->contentType('application/json')
             ->type('POST');
		...
		*/	
        ...
        $this->template->set('content_header_title', 'Program Related Document');
        
        $breadcrumb = '<ul class="breadcrumb">
						<li><a href="#"><i class="icofont-home"></i> RMIS</a> <span class="divider">›</span></li>
						<li><a href="#">Programs</a><span class="divider">›</span></li><li class="active">Program Related Document</li>
					  </ul>';
        $this->template->set('breadcrumb', $breadcrumb);
        
        $this->template->set_partial('sidebar', 'layouts/sidebar',$_data)
               ->build('relatedDocument/index');
    }
