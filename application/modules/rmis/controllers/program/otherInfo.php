...
class OtherInfo extends MX_Controller{
    ...
    public function index(){
		...
		*/	
        ...
        $this->template->set('content_header_title', 'Other Information');
        
        $breadcrumb = '<ul class="breadcrumb">
						<li><a href="#"><i class="icofont-home"></i> RMIS</a> <span class="divider">›</span></li>
						<li><a href="#">Programs</a><span class="divider">›</span></li><li class="active">Other Information</li>
					  </ul>';
        $this->template->set('breadcrumb', $breadcrumb);
        
        $this->template->set_partial('sidebar', 'layouts/sidebar',$_data)
               ->build('otherInfo/index');
    }
