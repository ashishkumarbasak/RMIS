...
class SteeringCommittee extends MX_Controller{
    private $_data;
    ...
    public function index(){
        $this->template->title('Research Management(RM)', ' Programs', ' Steering Committee Information');
        ...
        $create->url(site_url('rmis/program/steeringCommittee/dataCreate'))
             ->contentType('application/json')
             ->type('POST');

        $read = new \Kendo\Data\DataSourceTransportRead();

        $read->url(site_url('rmis/program/steeringCommittee/dataRead'))
             ->contentType('application/json')
             ->type('POST');

        $update = new \Kendo\Data\DataSourceTransportUpdate();

        $update->url(site_url('rmis/program/steeringCommittee/dataUpdate'))
             ->contentType('application/json')
             ->type('POST');

        $destroy = new \Kendo\Data\DataSourceTransportDestroy();

        $destroy->url(site_url('rmis/program/steeringCommittee/dataDestroy'))
             ->contentType('application/json')
             ->type('POST');
		...
		*/	
        ...
        $this->template->set('content_header_title', 'Steering Committee Information');
        
        $breadcrumb = '<ul class="breadcrumb">
						<li><a href="#"><i class="icofont-home"></i> RMIS</a> <span class="divider">›</span></li>
						<li><a href="#">Programs</a><span class="divider">›</span></li><li class="active">Steering Committee Information</li>
					  </ul>';
        $this->template->set('breadcrumb', $breadcrumb);
        
        $this->template->set_partial('sidebar', 'layouts/sidebar',$_data)
               ->build('steeringCommittee/index');
    }
