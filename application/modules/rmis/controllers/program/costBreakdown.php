...
class CostBreakdown extends MX_Controller{
    ...
    public function index(){
        $this->template->title('Research Management(RM)', ' Programs', ' Program Information');
		...
		*/	
        ...
        $this->template->set('content_header_title', 'Fund Source & Cost Breakdown');
        
        $breadcrumb = '<ul class="breadcrumb">
						<li><a href="#"><i class="icofont-home"></i> RMIS</a> <span class="divider">›</span></li>
						<li><a href="#">Programs</a><span class="divider">›</span></li><li class="active">Fund Source & Cost Breakdown</li>
					  </ul>';
        $this->template->set('breadcrumb', $breadcrumb);
        
        $this->template->set_partial('sidebar', 'layouts/sidebar',$_data)
               ->build('costBreakdown/index');
    }
